    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('curso1',ChoiceType::class, [
                'choices'  => [
                    'C3-De las peras y manzanas a la Geometría Algebraica' => 'C3',
                    'C4-Una invitación a la geometría tórica' => 'C4',
                ],
                'placeholder' => 'Seleccionar',
            ])
            ->add('curso2',ChoiceType::class, [
                'choices'  => [
                    'C5-Aplicaciones de análisis topológico de datos a Pangenómica' => 'C5',
                    'C6-Álgebra homológica Gorenstein; ¿Como comenzó, cómo va y a donde puede ir?'=>'C6',
                ],
                'placeholder' => 'Seleccionar',
            ])
            ->add('aceptado')
